...
export const AMBIENT_LIGHT = new Float32Array([0.20, 0.20, 0.20]);
...
export const STORAGE_CHEST_INTERACTION_DISTANCE = 2.25;
export const STORAGE_CHEST_INTERACTION_DISTANCE_SQ =
  STORAGE_CHEST_INTERACTION_DISTANCE * STORAGE_CHEST_INTERACTION_DISTANCE;
export const STORAGE_CHEST_VERTICAL_LIMIT = 1.75;
